...
class Task():
    def __init__(self, game):
        ...
        self.turn_on_the_lights_task_title = "Khôi phục thông tin minh bạch"
        self.turn_on_the_lights_task_title_visibility_status = False
        self.stabilize_nav_task_title = "Định hướng quy trình thanh tra"
        self.stabilize_nav_task_title_visibility_status = False
        self.reboot_the_wifi_task_title = "Khôi phục cổng công khai minh bạch"
        self.reboot_the_wifi_task_title_visibility_status = False
        self.empty_the_garbage_task_title = "Loại bỏ hồ sơ sai lệch"
        self.empty_the_garbage_task_title_visibility_status = False
        self.fix_electircity_wires_task_title = "Kết nối hệ thống giám sát"
        self.fix_electircity_wires_task_title_visibility_status = False
        self.divert_power_to_reactor_task_title = "Kích hoạt cơ chế kiểm soát quyền lực"
        self.divert_power_to_reactor_task_title_visibility_status = False
        self.align_engine_output_task_title = "Chuẩn hóa quy trình xử lý tố cáo"
        self.align_engine_output_title_visibility_status = False
        self.fuel_engine_task_title = "Bổ sung nguồn lực cho kiểm toán"
        self.fuel_engine_task_title_visibility_status = False
        self.clear_asteroids_task_title = "Ngăn chặn tin giả và lợi ích nhóm (30)"
